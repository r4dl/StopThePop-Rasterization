...
#ifndef CUDA_RASTERIZER_FORWARD_COMMON_H_INCLUDED
#define CUDA_RASTERIZER_FORWARD_COMMON_H_INCLUDED
...
__device__ glm::vec3 computeColorFromSH(int idx, int deg, int max_coeffs, const glm::vec3 mean3D, glm::vec3 campos, const float* shs, bool* clamped)
{
	// The implementation is loosely based on code for 
	// "Differentiable Point-Based Radiance Fields for 
	// Efficient View Synthesis" by Zhang et al. (2022)
	glm::vec3 dir = mean3D - campos;
